...
open class AsyncStorageIdlingResource internal constructor(module: NativeModule): IdlingResource {
    ...
    companion object {
        ...
        fun createIfNeeded(reactContext: ReactContext, legacy: Boolean): AsyncStorageIdlingResource? {
            ...
            RNHelpers.getNativeModule(reactContext, className)?.let { module ->
                ...
                return if (legacy) AsyncStorageIdlingResourceLegacy(module) else AsyncStorageIdlingResource(module)
            }
            return null
        }
    }
